<template>
  <div class="rounded-lg p-2 transition hover:bg-zinc-800 dark:hover:bg-zinc-700">
    ...
    >
      ...
      <span
        v-if="unreadCount > 0"
        class="absolute -right-1 -top-1 flex min-h-5 min-w-5
    ...
    <div
      v-if="isOpen"
      class="absolute right-0 z-50 mt-3 w-96 overflow-hidden
    ...
    >
      ...
      <div
        class="flex items-center justify-between border-b
               border-gray-200 px-4 py-3 dark:border-gray-700"
      >
        <div>
      ...
      >
        <button
          ...
          :key="notification.id"
          class="flex w-full gap-3 border-b border-gray-100
